        ...
        where c.date_out is not NULL
         ...
         initialaverage as (
             select
                 ...
                 printers_id,
                 cartridgeitems_id,
                 avg(if(plugin_fields_cartridgeitemtypedropdowns_id = 1, printed_pages_field + printed_pages_color_field, printed_pages_color_field)) as initial_avg
         ...
         filteredvalues as (
             select
                 ...
                 r.printers_id,
                 r.cartridgeitems_id,
                 if(r.plugin_fields_cartridgeitemtypedropdowns_id = 1, r.printed_pages_field + printed_pages_color_field, printed_pages_color_field) printed_pages_total,
                 r.date_out,
                 r.row_num,
                 r.plugin_fields_cartridgeitemtypedropdowns_id,
                 ia.initial_avg,
                 if (ci.atc_field * ia.initial_avg > 0, abs(if(r.plugin_fields_cartridgeitemtypedropdowns_id = 1, r.printed_pages_field + printed_pages_color_field, printed_pages_color_field) - ia.initial_avg) / ia.initial_avg <= 0.3
                     and abs(if(r.plugin_fields_cartridgeitemtypedropdowns_id = 1, r.printed_pages_field + printed_pages_color_field, printed_pages_color_field) - ci.atc_field) / ci.atc_field <= 0.6, FALSE) as within_range,
                 ci.atc_field,
                 ci.ref
         ...
         averagecalculation as (
             ...
             from filteredvalues
             group by printers_id, suppliers_id, cartridgeitems_id, plugin_fields_cartridgeitemtypedropdowns_id
         )

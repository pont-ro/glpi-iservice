...
// Note: number-type custom fields (VARCHAR/INT) are driven by the customfields JSON files
// and handled by AddCustomFieldsInstallStep. This file handles only what that step cannot:
//   - Indexes not added by the fields plugin
//   - Non-fields-plugin iService tables

...
echo "<a href='#' onclick='$(\"#popup_{$cartridge_id}_\").html(\"\");return false;'><img src='$CFG_GLPI[root_doc]/pics/delete.png' style='min-width:15px;'></a>";
echo "</td></tr>";
...
echo "<img src='$CFG_GLPI[root_doc]/plugins/iservice/pics/app_go_green.png' style='cursor: pointer; min-width: 25px; min-height: 20px;' title='" . __('Save') . "' onclick='$onclick'/>";
echo "</td></tr></table>";

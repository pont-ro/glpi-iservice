...
namespace GlpiPlugin\Iservice\Controller;
...
{
    #[Route('/client', name: 'iservice_client', methods: ['GET', 'POST'])]
    ...
    public function __invoke(Request $request): Response
    {
        ...
        if ($cui !== $partner_cui) {
            Html::header('iService', $request->getUri());
        ...
        Html::header($partner->fields['name'], $request->getUri(), 'plugin_iservice_views');

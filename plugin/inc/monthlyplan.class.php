...
?>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            if ($enterprise['numar_facturi'] > 0) {
                                                echo "<a href='" . $CFG_GLPI['root_doc'] . "/plugins/iservice/front/views.php?view=GlpiPlugin\Iservice\Views\UnpaidInvoices&unpaidinvoices0[cod]=$enterprise[hmarfa_code_field]'>**&nbsp;$enterprise[numar_facturi]&nbsp;**</a>";
                                            } else {

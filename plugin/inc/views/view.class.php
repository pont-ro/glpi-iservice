                ...
                if (!empty($import_data[$filter_data['import']['index']]['error'])) {
                    ...
                    if ($import_data['data_luc'] < date('Y-m-d', strtotime('-14days'))) {
                        if ($import_data['data_luc'] < date('Y-m-d', strtotime('-1000days'))) {
                            ...
                            $estimate_text = "Datele din CSV sunt mai vechi de 14 zile (din " . date('Y-m-d', strtotime($import_data['data_luc'])) . '). ' . $this->evalIfFunction($filter_data['import']['estimate_text'] ?? '', ['param_data' => $params]);
                        }

...
return [
    'query' => "
        ...
        from (
          select c.id cid, cfc.suppliers_id_field sid, count(t1.pid) printer_count
          ...
          left join (
            ...
            join glpi_infocoms ic on ic.items_id = p.id and ic.itemtype = 'Printer' and ic.suppliers_id = cfc.suppliers_id_field

...
return [
    ...
    'test' => [
        ...
        'positive_result' => [
            ...
            'iteration_text' => "Cartridge <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/view.php?view=cartridges&cartridges0%5Bid%5D=[cid]' target='_blank'>[cid]</a> was installed by [ticket_count] tickets: [ticket_ids]. See operations list for printer <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/view.php?view=operations&operations0%5Bprinter_id%5D=[pid]' target='_blank'>[pid]</a>",
        ],
    ],
];

...
return [
    ...
    'test' => [
        ...
        'positive_result' => [
            ...
            'iteration_text' => "Cartridge <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/views.php?view=GlpiPlugin\Iservice\Specialviews\Cartridges&cartridges0%5Bid%5D=[id]' target='_blank'>[id]</a> on printer <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/views.php?view=GlpiPlugin\Iservice\Specialviews\Operations&operations0%5Bprinter_id%5D=[printers_id]' target='_blank'>[printers_id]</a> has negative printed pages: [bk] black and [color] color - installer tikcet <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/ticket.form.php?id=[install_ticket_id]&mode=9999' target='_blank'>[install_ticket_id]</a>, remover ticket <a href='$CFG_GLPI[root_doc]/plugins/iservice/front/ticket.form.php?id=[out_ticket_id]&mode=9999' target='_blank'>[out_ticket_id]</a>",
        ],
    ],
];

...
return [
    ...
    'test' => [
        ...
        'positive_result' => [
            ...
            'iteration_text' => "Tikcet <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/ticket.form.php?id=[tickets_id_out_field]' target='_blank'>[tickets_id_out_field]</a> installs no cartridges but uninstalls cartridge <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/views.php?view=Cartridges&cartridges0%5Bid%5D=[id]' target='_blank'>[id]</a>",
        ],
    ],
];

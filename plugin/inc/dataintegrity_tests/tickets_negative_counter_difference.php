...
return [
    ...
    'test' => [
        ...
        'positive_result' => [
            ...
            'iteration_text' => "Printer <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/views.php?view=Operations&operations0%5Bprinter_id%5D=[pid]' target='_blank'>[pid]</a> has negative counter difference (bk: -[black_difference], color: -[color_difference]) for tickets <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/ticket.form.php?id=[tid]' target='_blank'>[tid]</a> from <i>[effective_date_field]</i> and <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/ticket.form.php?id=[next_tid]' target='_blank'>[next_tid]</a> from <i>[next_data_luc]</i>",
        ],
    ],
    'schedule' => [
        ...
        'h:m'                 => ['4:01', '14:01'],
        'ignore_text'         => [
            'hours' => "Checked only at 4:01 and 14:01",
        ]
    ]
];

...
return [
    'query' => "
        ...
        from (
              ...
              where cfc.tickets_id_out_field is not null and cfc.tickets_id_use_field is not null
              group by cfc.tickets_id_out_field, cfci.mercury_code_field, cfci.plugin_fields_cartridgeitemtypedropdowns_id 
             ) t
        where `count` > 1
        ",
    'test' => [

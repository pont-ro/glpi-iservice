...
return [
    ...
    'test' => [
        ...
        'positive_result' => [
            ...
            'iteration_text' => "Printer with serial <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/views.php?view=Cartridges&cartridges0%5Bprinter_name%5D=[serial]' target='_blank'>[serial]</a> at partner [supplier] has the following [type_name] cartridges: [ids]",
        ],
    ],
];

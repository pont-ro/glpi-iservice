...
return [
    ...
    'test' => [
        ...
        'positive_result' => [
            ...
            'iteration_text' => "Ticket <a href='$CFG_PLUGIN_ISERVICE[root_doc]/front/ticket.form.php?id=[id]' target='_blank'>[id]</a> with effective date <b>[effective_date_field]</b> has no consumables but <b>[export_type]</b> export type",
        ],
    ],
];

    ...
    protected static function getItemsFromInput(array $buttons): array
    {
        ...
        $result['contracts'] = IserviceToolBox::getQueryResult(
            ...
            SELECT 
              ...
              , c.num
              , ccf.currency_field
              , ccf.copy_price_divider_field
              , ccf.included_copies_bk_field
              , ccf.included_copies_col_field
              , ccf.included_copy_value_field
              , ccf.monthly_fee_field
              , ccf.copy_price_bk_field
              , ccf.copy_price_col_field

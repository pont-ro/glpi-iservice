...
class ToolBox
{
    ...
    {
        $get_result  = filter_input(INPUT_GET, 'iServiceCompressedInputData') ?
            ($_GET[$variable_name] ?? null) :
            (filter_input(INPUT_GET, $variable_name) ?: filter_input(INPUT_GET, $variable_name, FILTER_DEFAULT, FILTER_REQUIRE_ARRAY));
        $post_result = filter_input(INPUT_POST, 'iServiceCompressedInputData') ?
            ($_POST[$variable_name] ?? null) :
            (filter_input(INPUT_POST, $variable_name) ?: filter_input(INPUT_POST, $variable_name, FILTER_DEFAULT, FILTER_REQUIRE_ARRAY));

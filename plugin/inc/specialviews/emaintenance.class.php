        ...
        return [
            ...
            'query' => "
                        SELECT 
                          ...
                          , pc.usage_address_field printer_usageaddress
                          , pc.cost_center_field costcenter
                        ...
                        LEFT JOIN glpi_plugin_fields_printerprintercustomfields pc on pc.items_id = p.id and pc.itemtype = 'Printer'
                        ...
                        WHERE eme.read in ([read])
                          ...
                          AND ((pc.cost_center_field is null AND '[costcenter]' = '%%') OR pc.cost_center_field like '[costcenter]')
                          [tech_id]
                        ",
